set(PACKAGE_VERSION "3.0.0-beta-4")
set(${PACKAGE_FIND_NAME}_VERSION_PRERELEASE "beta-4" PARENT_SCOPE)
...
elseif(PACKAGE_FIND_VERSION VERSION_EQUAL PACKAGE_VERSION)
  ...
  if(NOT "beta-4" STREQUAL "" AND PACKAGE_FIND_VERSION_PRERELEASE STREQUAL "")
    message(AUTHOR_WARNING "To use this prerelease version of ${PACKAGE_FIND_NAME}, set ${PACKAGE_FIND_NAME}_FIND_VERSION_PRERELEASE to 'beta-4' or greater.")
    set(PACKAGE_VERSION_COMPATIBLE FALSE)
  endif()

  # Not robustly SemVer compliant, but protobuf never uses '.' separated prerelease identifiers.
  if(PACKAGE_FIND_VERSION_PRERELEASE STRGREATER "beta-4")
    set(PACKAGE_VERSION_COMPATIBLE FALSE)
  endif()
endif()
